...
#ifndef _EMBEDDED_RPC__KOTLINGENERATOR_H_
#define _EMBEDDED_RPC__KOTLINGENERATOR_H_
 ...
 */
class KotlinGenerator : public Generator
{
public:
    /*!
     * @brief This function is constructor of KotlinGenerator class.
     *
     * @param[in] def Contains all Symbols parsed from IDL files.
     */
    explicit KotlinGenerator(InterfaceDefinition *def, const std::string kotlinPackageName);

    /*!
     * @brief This function is destructor of KotlinGenerator class.
     *
     * This function close opened files.
     */
    virtual ~KotlinGenerator() {}
...
protected:
    ...
    std::string m_kotlinPackageName; //!< Used kotlin package.
    ...
    /*!
     * Stores reserved words for Kotlin program language.
     */
    void initKotlinReservedWords();
};

} // namespace erpcgen

#endif // _EMBEDDED_RPC__KOTLINGENERATOR_H_
