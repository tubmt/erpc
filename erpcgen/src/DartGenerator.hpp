...
#ifndef _EMBEDDED_RPC__DARTGENERATOR_H_
#define _EMBEDDED_RPC__DARTGENERATOR_H_
 ...
 */
class DartGenerator : public Generator
{
public:
    /*!
     * @brief This function is constructor of DartGenerator class.
     *
     * @param[in] def Contains all Symbols parsed from IDL files.
     */
    explicit DartGenerator(InterfaceDefinition *def, const std::string dartPackageName);

    /*!
     * @brief This function is destructor of DartGenerator class.
     *
     * This function close opened files.
     */
    virtual ~DartGenerator() {}
...
protected:
    ...
    std::string m_dartPackageName; //!< Used dart package.
    ...
    /*!
     * Stores reserved words for Dart program language.
     */
    void initDartReservedWords();
};

} // namespace erpcgen

#endif // _EMBEDDED_RPC__DARTGENERATOR_H_
